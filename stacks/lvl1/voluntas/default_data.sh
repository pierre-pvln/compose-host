...
echo "Copying Joomla! kickstart environment to container volume"
sudo cp --recursive ../../../../services/"${MY_PLATFORM}"/"${MY_CONTAINER_NAME}"/files/kickstart/* "${MY_WEB_DATA_VOLUME}"
